...
@NamedNativeQueries( {
	@NamedNativeQuery(name = "getWaitingMonteCarloRequest", query = "SELECT *  FROM jobqueue   WHERE readyToExecute = true AND processing = false", resultClass = ModelJobQueue.class),
	@NamedNativeQuery(name = "getMonteJobs", query = "SELECT * FROM jobqueue WHERE jobtype = 'MONTE' AND readyToExecute > 0 ORDER BY queuedDate DESC", resultClass = ModelJobQueue.class),
	@NamedNativeQuery(name = "getReportJobs", query = "SELECT * FROM jobqueue WHERE jobtype = 'REPORT' AND readyToExecute > 0 ORDER BY queuedDate DESC", resultClass = ModelJobQueue.class),
	@NamedNativeQuery(name = "getEmailJobs", query = "SELECT * FROM jobqueue WHERE jobtype = 'EMAIL' AND readyToExecute > 0 ORDER BY queuedDate DESC", resultClass = ModelJobQueue.class),
	@NamedNativeQuery(name = "getUserJobs", query = "SELECT * FROM jobqueue WHERE userID = :userID ORDER BY queuedDate DESC", resultClass = ModelJobQueue.class)
})
@Entity
@Table(name="jobqueue")
public class ModelJobQueue implements Serializable  {
