...
@NamedNativeQueries( {
	@NamedNativeQuery(name = "getMetricConfig", callable = true, query = "call getMetricConfig(:projectID,:metricID)", resultClass = ModelMetric.class)
})
...
public class ModelMetric  implements Serializable {
	...
	public Boolean configRange;
	 ...
	 /**
 	 * Instantiates a new model metric.
 	 */
 	public ModelMetric(){}
