...
@WebServlet (value = "/deleteMitStepUpdate", asyncSupported = false)
public class ServletDeleteMitStepUpdate extends QRMRPCServlet {
	...
	void execute(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			for (Object obj : (JSONArray) parser.parse(stringMap.get("DATA"))) {
				...
				ModelUpdateComment update = (ModelUpdateComment)sess.load(ModelUpdateComment.class,id);
				sess.delete(update);
