...
@WebServlet (value = "/getIncidentAttachments", asyncSupported = false)
public class ServletGetIncidentAttachments extends QRMRPCServlet {
	...
	void execute(HttpServletRequest request, HttpServletResponse response,
		...
		try {
			...
			String sql = "SELECT internalID, attachmentFileName, attachmentURL, fileType, description, hostID, hostType FROM attachment WHERE hostID="
					+ stringMap.get("INCIDENTID")
					+ " AND hostType='INCIDENT'";
